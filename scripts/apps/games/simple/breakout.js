...
function setup() {
    ...
    if (game.start) {
        ...
        ball = {
            ...
            s_speed  : [1.5, 3][game.size[2]],
            m_speed  : [3, 6][game.size[2]] * game.level.mod[1],
            ...
            speedup: function() {
                ...
                if (game.level.current == 3) this.speed += [0.04, 0.08][game.size[2]];
                else {
                    this.speed += [0.08, 0.16][game.size[2]];
